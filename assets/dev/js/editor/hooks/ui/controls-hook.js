export default class ControlsHook extends $e.modules.hookUI.After {
	...
	getId() {
		...
		return 'hello-plus-editor-controls-handler';
	}

	/**
	 * Get Hello Plus Theme Controls
	 *
	 ...
	 *   {
	 *      hello_plus_show_logo: '.site-header .site-header-logo',
	 *      hello_plus_show_menu: '.site-header .site-header-menu',
	 *   }
	 */
	getHelloPlusThemeControls() {
		return {
			hello_header_logo_display: {
				selector: '.site-header .site-logo, .site-header .site-title',
				callback: ( $element, args ) => {
					this.toggleShowHideClass( $element, args.settings.hello_plus_header_logo_display );
				},
			},
			hello_plus_header_menu_display: {
				selector: '.site-header .site-navigation, .site-header .site-navigation-toggle-holder',
				callback: ( $element, args ) => {
					this.toggleShowHideClass( $element, args.settings.hello_plus_header_menu_display );
				},
			},
			hello_plus_header_tagline_display: {
				selector: '.site-header .site-description',
				callback: ( $element, args ) => {
					this.toggleShowHideClass( $element, args.settings.hello_plus_header_tagline_display );
				},
			},
			hello_plus_header_logo_type: {
				...
				callback: ( $element, args ) => {
					const classPrefix = 'show-',
						inputOptions = args.container.controls.hello_plus_header_logo_type.options,
						inputValue = args.settings.hello_plus_header_logo_type;
			...
			hello_plus_header_layout: {
				...
				callback: ( $element, args ) => {
					const classPrefix = 'header-',
						inputOptions = args.container.controls.hello_plus_header_layout.options,
						inputValue = args.settings.hello_plus_header_layout;
			...
			hello_plus_header_width: {
				...
				callback: ( $element, args ) => {
					const classPrefix = 'header-',
						inputOptions = args.container.controls.hello_plus_header_width.options,
						inputValue = args.settings.hello_plus_header_width;
			...
			hello_plus_header_menu_layout: {
				...
				callback: ( $element, args ) => {
					const classPrefix = 'menu-layout-',
						inputOptions = args.container.controls.hello_plus_header_menu_layout.options,
						inputValue = args.settings.hello_plus_header_menu_layout;
			...
			hello_plus_header_menu_dropdown: {
				...
				callback: ( $element, args ) => {
					const classPrefix = 'menu-dropdown-',
						inputOptions = args.container.controls.hello_plus_header_menu_dropdown.options,
						inputValue = args.settings.hello_plus_header_menu_dropdown;
			...
			hello_plus_footer_logo_display: {
				...
				callback: ( $element, args ) => {
					this.toggleShowHideClass( $element, args.settings.hello_plus_footer_logo_display );
				},
			},
			hello_plus_footer_tagline_display: {
				selector: '.site-footer .site-description',
				callback: ( $element, args ) => {
					this.toggleShowHideClass( $element, args.settings.hello_plus_footer_tagline_display );
				},
			},
			hello_plus_footer_menu_display: {
				selector: '.site-footer .site-navigation',
				callback: ( $element, args ) => {
					this.toggleShowHideClass( $element, args.settings.hello_plus_footer_menu_display );
				},
			},
			hello_plus_footer_copyright_display: {
				...
				callback: ( $element, args ) => {
					const $footerContainer = $element.closest( '#site-footer' ),
						inputValue = args.settings.hello_plus_footer_copyright_display;
			...
			hello_plus_footer_logo_type: {
				...
				callback: ( $element, args ) => {
					const classPrefix = 'show-',
						inputOptions = args.container.controls.hello_plus_footer_logo_type.options,
						inputValue = args.settings.hello_plus_footer_logo_type;
			...
			hello_plus_footer_layout: {
				...
				callback: ( $element, args ) => {
					const classPrefix = 'footer-',
						inputOptions = args.container.controls.hello_plus_footer_layout.options,
						inputValue = args.settings.hello_plus_footer_layout;
			...
			hello_plus_footer_width: {
				...
				callback: ( $element, args ) => {
					const classPrefix = 'footer-',
						inputOptions = args.container.controls.hello_plus_footer_width.options,
						inputValue = args.settings.hello_plus_footer_width;
			...
			hello_plus_footer_copyright_text: {
				selector: '.site-footer .copyright',
				callback: ( $element, args ) => {
					const inputValue = args.settings.hello_plus_footer_copyright_text;
	...
	getConditions( args ) {
		...
		return !! Object.keys( this.getHelloPlusThemeControls() ).includes( changedControls[ 0 ] );
	}
	 ...
	 */
	apply( args ) {
		const allThemeControls = this.getHelloPlusThemeControls(),
